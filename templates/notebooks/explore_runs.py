            ...
            rows.append(
                {
                    ...
                    "cfg_w_supcon_instance_target": cfg.get("loss.w_supcon_instance_target", cfg.get("loss_weight_supcon_instance")),
                    "cfg_w_supcon_protocol_target": cfg.get("loss.w_supcon_protocol_target", cfg.get("loss_weight_supcon_protocol")),
                    "cfg_w_patch_size": cfg.get("loss.w_patch_size", cfg.get("loss_weight_patch_size")),
                    "cfg_source_patch_mm_max": cfg.get("data.source_patch_mm_max", cfg.get("source_patch_mm_max")),
        ...
        return (
            ...
            .select(
                [
                    ...
                    "cfg_batch_size",
                    "cfg_warm_pool_size",
                    "cfg_w_supcon_instance_target",
                    "cfg_w_supcon_protocol_target",
                    "cfg_w_patch_size",
                    "cfg_source_patch_mm_max",
